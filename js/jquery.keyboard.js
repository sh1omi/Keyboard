...
;(function (factory) {
		...
		base.$allKeys = base.$keyboard.find('button.' + kbcss.keyButton)
			...
			.bind('mouseenter mouseleave touchstart '.split(' ').join(base.namespace + ' '), function (e) {
				...
				if ((type === 'mouseenter' || type === 'touchstart') && base.el.type !== 'password' &&
					...
					$this.removeClass(o.css.buttonDefault);
					if (o.useWheel && base.wheel) {
				...
				if (type === 'mouseleave') {
					...
					$this.addClass(o.css.buttonDefault);
					if (o.useWheel && base.wheel) {
						last.wheelIndex = 0;
						last.wheelLayers = [];
	...
	base.addKey = function (keyName, action, regKey) {
		...
		// add the wide class
		keyClass += (keys.name.length > 2 ? ' ' + kbcss.keyWide : '') + ' btn ' + o.css.buttonDefault;
			...
			if (/^\{\S+\}$/.test(keys[key])) {
				...
				case 'accept':
					base
						...
						.addClass('btn-success ' + kbcss.keyAction);
					break;
				...
				case 'cancel':
					base
						...
						.addClass('btn-danger ' + kbcss.keyAction);
					break;
